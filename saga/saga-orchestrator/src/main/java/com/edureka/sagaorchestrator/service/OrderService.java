...
public class OrderService {
    ...
    public Order placeOrder(Order order) {
        ...
        sendOrderEvent(order, OrderEvent.BOOK_AIRLINE); // fire the event
        return savedOrder;
    }
...
//            order.setOrderStatus(OrderStatus.NEW);
            ...
            sendOrderEvent(order, OrderEvent.BOOK_AIRLINE_COMPLETED); // fire the event
...
//            order.setOrderStatus(OrderStatus.FAILED);
            ...
            sendOrderEvent(order, OrderEvent.BOOK_HOTEL_FAILED); // fire the event
